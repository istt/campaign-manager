...
To optimize the CampaignManager application for production, run:
...
[Doing API-First development]: https://www.jhipster.tech/documentation-archive/v5.6.1/doing-api-first-development/
