    ...
    describe('DataFile Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/data-files';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });

            it('should create a DataFile', () => {
                service.create(new DataFile(null)).subscribe(received => {
            ...
            it('should update a DataFile', () => {
                service.update(new DataFile('123')).subscribe(received => {
